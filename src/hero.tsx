...
export default function Hero() {
    return (
        <>
            {/* Top banner */}
            <div className="relative w-full md:h-150 overflow-hidden">
                ...
                <div className="hidden md:block absolute top-1/2 -left-70 -translate-y-1/2 w-250 h-250 bg-[var(--main-blue)] opacity-80 rounded-full"/>
                {/* Title and buttons */}
                <div className="absolute top-1/2 left-1/2 md:left-16 -translate-y-1/2 -translate-x-1/2 md:translate-x-0 z-10 md:w-150 w-3/4 flex flex-col space-y-8 text-center md:text-left items-center md:items-start">
                    <Label className="text-[var(--secondary-pale-blue)] text-5xl md:text-8xl font-bold leading-tight">
                        Find Your Happy Place
                    </Label>
                    <div className="space-x-4 md:space-x-8 flex md:flex-row w-full md:w-auto items-center md:items-start justify-center md:justify-start">
                        <Button>
                            Book a Session
                        </Button>
                        <Button>
